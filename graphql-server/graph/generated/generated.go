...
type ComplexityRoot struct {
	...
	Resposta struct {
		...
		Sublist   func(childComplexity int) int
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Resposta.positions":
		...
		return e.complexity.Resposta.Positions(childComplexity), true

	case "Resposta.sublist":
		if e.complexity.Resposta.Sublist == nil {
			break
		}

		return e.complexity.Resposta.Sublist(childComplexity), true

	case "Resposta.sum":
		if e.complexity.Resposta.Sum == nil {
			break
		}

		return e.complexity.Resposta.Sum(childComplexity), true
...
func (ec *executionContext) _Resposta_sum(ctx context.Context, field graphql.CollectedField, obj *model.Resposta) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
var respostaImplementors = []string{"Resposta"}

func (ec *executionContext) _Resposta(ctx context.Context, sel ast.SelectionSet, obj *model.Resposta) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, respostaImplementors)
