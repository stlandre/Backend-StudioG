# Backend-StudioG
<p align="justify">Solução backend desenvolvida em GoLang (go1.17.5) utilizando um server GraphQL.</p>

## O problema
<p align="justify">Dada uma lista de números inteiros, o objetivo é encontrar quais as posições da lista possume a maior soma obtida a partir de uma sub-lista contínua não vazia.
